...
# app
bot_token = os.environ.get("TOKEN", "5431709898:AAHSXSkQ3LEPQmBi0LmRIAON3rfda6cmxGo") 
api_hash = os.environ.get("HASH", "9073255ce64a6072a59099803493f97d") 
api_id = os.environ.get("ID", "1976680")
